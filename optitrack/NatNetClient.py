...
import core.optitrack.DataDescriptions as DataDescriptions
...
#Unpack Mocap Data Functions
    ...
    def __unpack_mocap_data( self, data : bytes, packet_size, major, minor):
        ...
        mocap_data.set_timestamp(time.perf_counter())
    ...
    def __unpack_asset_marker_data( self, data, major, minor ):
        ...
        marker_data = AssetMarkerData(marker_id, pos, marker_size, marker_params, residual)
    ...
    def __process_message( self, data : bytes, print_level=0): 
        ...
        if message_id == self.NAT_FRAMEOFDATA :
            ...
            # TODO: save mocap data
            self.mocap_data.append(mocap_data)
    ...
    def clear_mocap_data(self):
        self.mocap_data.clear()
