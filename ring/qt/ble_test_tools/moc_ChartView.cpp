...
struct qt_meta_stringdata_CLASSChartViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSChartViewENDCLASS = QtMocHelpers::stringData(
    "ChartView"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSChartViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ChartView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSChartViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSChartViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSChartViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ChartView, std::true_type>
    >,
    nullptr
} };
...
void *ChartView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSChartViewENDCLASS.stringdata0))
